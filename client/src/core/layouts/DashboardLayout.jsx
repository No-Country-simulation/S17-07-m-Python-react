  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <List>
          {/* Botón Home */}
          <ListItem button component={Link} to="/" sx={{ color: isActive('/') ? theme.palette.primary.main : '#fff' }}>
          ...
          <ListItem button component={Link} to="/artistas" sx={{ color: isActive('/artistas') ? theme.palette.primary.main : '#fff' }}>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <Button
                sx={{
                  display: 'flex',
                  alignItems: 'center',
                  gap: '15px',
                  color: isActive('/artistas') ? theme.palette.primary.main : '#fff',
                  textTransform: 'none',
                }}
              >
                <Box
                  ...
                  sx={{
                    width: '24px',
                    height: '24px',
                    fill: isActive('/artistas') ? theme.palette.primary.main : '#fff',
                  }}
                >
          ...
          {/* Botón Tus me gusta */}
          <ListItem button component={Link} to="/me-gusta" sx={{ color: isActive('/me-gusta') ? theme.palette.primary.main : '#fff' }}>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <Button
                sx={{
                  display: 'flex',
                  alignItems: 'center',
                  gap: '15px',
                  color: isActive('/me-gusta') ? theme.palette.primary.main : '#fff',
                  textTransform: 'none',
                }}
              >
                <Box
                  ...
                  sx={{
                    width: '24px',
                    height: '24px',
                    fill: isActive('/me-gusta') ? theme.palette.primary.main : '#fff',
                  }}
                >
          ...
          {/* Botón Descubrir */}
          <ListItem button component={Link} to="/descubrir" sx={{ color: isActive('/descubrir') ? theme.palette.primary.main : '#fff' }}>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <Button
                sx={{
                  display: 'flex',
                  alignItems: 'center',
                  gap: '15px',
                  color: isActive('/descubrir') ? theme.palette.primary.main : '#fff',
                  textTransform: 'none',
                }}
              >
                <Box
                  ...
                  sx={{
                    width: '24px',
                    height: '24px',
                    fill: isActive('/descubrir') ? theme.palette.primary.main : '#fff',
                  }}
                >
          ...
          <ListItem button component={Link} to="/crear-playlist" sx={{ color: isActive('/crear-playlist') ? theme.palette.primary.main : '#fff' }}>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <Button
                sx={{
                  display: 'flex',
                  alignItems: 'center',
                  gap: '15px',
                  color: isActive('/crear-playlist') ? theme.palette.primary.main : '#fff',
                  textTransform: 'none',
                }}
              >
                <Box
                  ...
                  sx={{
                    width: '24px',
                    height: '24px',
                    fill: isActive('/crear-playlist') ? theme.palette.primary.main : '#fff',
                  }}
                >
                  <path d="M21 7V19C21 20.1046 20.1046 21 19 21H7M9 8.5V11.5L12 10L9 8.5ZM17 15V5C17 3.89543 16.1046 3 15 3H5C3.89543 3 3 3.89543 3 5V15C3 16.1046 3.89543 17 5 17H15C16.1046 17 17 16.1046 17 15Z" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                </Box>
